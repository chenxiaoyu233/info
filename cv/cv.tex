...
\begin{tabularx}{\textwidth}{@{\hskip 0pt}l@{\hskip 0pt}X@{\hskip 0pt}r@{\hskip 0pt}}
  \textbf{Postdoctoral Associate} (2025 --- \textbf{present}) & & Massachusetts Institute of Technology \\
  & & LIDS
\end{tabularx}
...
\begin{tabularx}{\textwidth}{@{\hskip 0pt}l@{\hskip 0pt}X@{\hskip 0pt}r@{\hskip 0pt}}
  \textbf{Ph.D.} in Computer Science (2020 --- 2025) & & Nanjing University \\
...
\begin{tabularx}{\textwidth}{@{\hskip 0pt}lXr@{\hskip 1em}r@{\hskip 0pt}}
  CCF Doctoral Dissertation Incentive Program & & China Computer Federation & 2025 \\
...
\begin{xltabular}{\textwidth}{@{\hskip 0pt}lX@{\hskip 0pt}}
Faster mixing of the Jerrum-Sinclair chain\\
\hspace{20pt} FOCS, 2025\\
\hspace{20pt} Algorithms and Complexity Seminar, MIT, 2025\\
\\
...
External reviewer for: RANDOM 2022, SODA 2024, STOC 2025, COCOON 2025, SODA 2025, FOCS 2026, RANDOM 2026, SODA 2027.
